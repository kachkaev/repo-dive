  ...
  Effect.gen(function* () {
    ...
    return {
      ...
      hints: [
        ...
        "Order snapshot metrics (languages.*, files.*, survival.*, …) by committed_at — that is when the tree looked like that; authored_at can run months behind it and does not increase along the history.",
